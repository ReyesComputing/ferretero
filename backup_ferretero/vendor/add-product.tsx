  ...
  return (
    <ScrollView className="flex-1 bg-gray-50 px-6 py-6">
      ...
      <View className="space-y-4 mb-10">
        ...
        <View>
          <Text className="text-gray-600 mb-2 font-semibold">Marca</Text>
          <TextInput
            className="bg-white border border-gray-200 p-4 rounded-xl"
            placeholder="Ej: Argos, Corona, Stanley, Pavco"
            value={form.brand}
        ...
        <TouchableOpacity
          onPress={handleSave}
          disabled={loading}
          className={`bg-blue-600 py-4 rounded-xl items-center mt-6 ${loading ? 'opacity-50' : ''}`}
        >
